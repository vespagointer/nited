<div class="text-center">
    <img src="<?=$imgPro;?>" class="img-thumbnail rounded " height="150px" id="imgProfile">
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center"><input type="file" name="image" id="image" class="visually-hidden"
                    accept="image/gif, image/jpeg, image/png" /><button type="button"
                    class="btn btn-primary btn-sm w-50 mb-3" id="btnbrows">เลือกรูป</button>

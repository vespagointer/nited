...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><i class="fas fa-chart-line" style="font-size:32px;"></i> <i class="bi bi-ui-checks"></i>&nbsp;SPM.NAN BigData</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=spm">ข้อมูล
                                สพม.น่าน</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=spmlist">รายชื่อบุคลากร</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=spmaward">ผลงาน</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=project">โครงการ</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="https://cert.spmnan.go.th/" target="_blank">ระบบพิมพ์เกียรติบัตร</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">รายชื่อ</a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=school">รายชื่อโรงเรียน</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=teacherlist">รายชื่อครู</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=report">รายงานรวม</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=scout">ข้อมูลลูกเสือ</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=list&mode=scpr">ข่าวประชาสัมพันธ์จากโรงเรียน</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=list&mode=gallery">ภาพกิจกรรมของโรงเรียน</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=list&mode=scaward">รางวัลที่โรงเรียนได้รับ</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=list&mode=taward">รางวัลที่ครูได้รับ</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=stdaward">รางวัลที่นักเรียนได้รับ</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=list&mode=train1">การอบรม/ประชุม/สัมนา</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=list&mode=train2">การพัฒนาตนเอง</a></li>
                        <li><a class="dropdown-item" style="font-size:0.75rem;" href="index.php?module=list&mode=publish">เผยแพร่ผลงาน</a></li>
                    </ul>
                </li>

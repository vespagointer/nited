        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="tel" class="form-control" value="<?=$ditel;?>" name="ditel" id="ditel" pattern="[0]{1}[0-9]{9}"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row" class="fit">โทรศัพท์</th>
                    <td><input type="tel" class="form-control" value="<?=$subditel1;?>" name="subditel1" id="subditel1" pattern="[0]{1}[0-9]{9}">
                    </td>
                </tr>
                <tr>
                    <th scope="row" class="fit">รองผู้อำนวยการ</th>
                ...
                <tr>
                    <th scope="row" class="fit">โทรศัพท์</th>
                    <td><input type="tel" class="form-control" value="<?=$subditel2;?>" name="subditel2" id="subditel2" pattern="[0]{1}[0-9]{9}">
                    </td>
                </tr>
                <tr>
                    <th scope="row" class="fit">รองผู้อำนวยการ</th>
                ...
                <tr>
                    <th scope="row" class="fit">โทรศัพท์</th>
                    <td><input type="tel" class="form-control" value="<?=$subditel3;?>" name="subditel3" id="subditel3" pattern="[0]{1}[0-9]{9}">
                    </td>
                </tr>
                <tr>
                    <th scope="row" class="fit">รองผู้อำนวยการ</th>
                ...
                <tr>
                    <th scope="row" class="fit">โทรศัพท์</th>
                    <td><input type="tel" class="form-control" value="<?=$subditel4;?>" name="subditel4" id="subditel4" pattern="[0]{1}[0-9]{9}">
                    </td>
                </tr>
                <tr>

...
<table class="table table-striped table-bordered bg-light">
    <thead class="thead-inverse">
        <tr>
            <th class="text-center"># <a href='index.php?module=teacher&sort=<?=$resort;?>&page=<?=$page;?>'><i class="fas fa-sort"></i></a></th>
    ...
    while ($data = mysqli_fetch_assoc($result)) {
        ...
        <tr>
            ...
            <td class="text-center">
                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="รับย้าย" class="movebtn" data-id="<?=$id;?>">

...
} else if (@$_SESSION["ss_status"] == "spm") {
    header("location:./spm");
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="กลุ่มนิเทศ ติดตามและประเมินผลการจัดการศึกษา สำนักงานเขตพื้นที่การศึกษามัธยมศึกษาน่าน">
...
<body class="bg-dark">
    <div class="container ">
        <div class="row">
            <div class="col-sx-10 col-sm-8 col-md-7 col-lg-5 mx-auto">
                <div class="card my-3" id="MyForm">
                    ...
                    <form class="card-body cardbody-color p-lg-3" action="takelogin.php" id="TakeLogin">
                        ...
                        <div class="text-center"><button type="submit" class="btn btn-dark btn-lg px-5 mb-5 w-100">Login</button></div>
                    </form>
    ...
    <footer>
        ...
        <div class="text-center p-4 text-white-50">
            พัฒนาเว็บไซต์โดย กฤษฎาพงษ์ สุตะ
        </div>
        <!-- Copyright -->
    </footer>
    ...
    $("#TakeLogin").submit(function(event) {
        ...
        posting.done(function(data) {
            ...
            if (data == "OK") {
                ...
                $("#MyForm").empty().html(mymsg + "./spm/" + mymsg2);
                window.location.replace("./spm/");
            } else {
                $("#msg").show();
